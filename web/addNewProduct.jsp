<%-- 
    ...
    Created on : Jan 20, 2021, 8:26:40 AM
    Author     : Asus
--%>
            ...
            <div class="col-lg-7">
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                    <div class="card-header" style="background: black">
                        <p class="text-center font-weight-light my-4" style="font-size: xx-large;color: white">CREATE NEW PRODUCT</p>
                    </div>
                    <div class="card-body">
                        <form action="MainController" method="POST">
                            ...
                            <div class="modal-footer justify-content-between">
                                <input name="action" type="submit" class="btn btn-primary btn-block"  value="Create">
                            </div>
                        </form>
                    </div>
                </div>
