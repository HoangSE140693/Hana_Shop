...
public class ViewProductController extends HttpServlet {
        ...
        private static final Logger LOGGER = Logger.getLogger(ViewProductController.class.getName());
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Product> result = dao.getListProduct(index);
            float maximumPrice = dao.getMaximumPrice();
