...
public class ViewOrderHistoryController extends HttpServlet {
        ...
        private static final Logger LOGGER = Logger.getLogger(ViewOrderHistoryController.class.getName());
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<OrderDTO> listOrder = orderDAO.getListOrderByUserID(userID);
